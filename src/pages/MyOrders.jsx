...
function MyOrders(){
    ...
    return (
        <div className="container-fluid text-dark" style={{minHeight:'80vh'}}>
            <div className="row">
                    ...
                    <tbody>
                        {orders.map(x=>(
                            <tr key={x.orderid}>
                                ...
                                <td><button onClick={e=>showDetails(x.orderid)} className="btn btn-secondary btn-sm">Show Details</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>  
